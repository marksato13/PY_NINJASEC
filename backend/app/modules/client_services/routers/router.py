...
def list_client_services(
    ...
    # Filtrar solo servicios de clientes de la organización del usuario
    stmt = (
...
def create_client_service(
    ...
    # Evitar duplicados: mismo client_id + service_id
    existing = db.scalar(
    ...
    if existing:
        raise HTTPException(
            status_code=409,
            detail="Service already linked to this client",
        )
...
def update_client_service(
    ...
    # Verificar que pertenece a la org del usuario
